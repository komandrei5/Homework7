...
public class Subscriber {
    ...
    public Subscriber(int id, String lastName, String firstName, String city, String phoneNumber, String contractNumber, double balance, int cityCallDuration, int interCityCallDuration, double internetTraffic) {
        this.id = id;
